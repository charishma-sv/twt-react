      ...
      <Container fluid className="p-0 pt-1 pb-1">
        <Container className="w-100">
          <Row className="w-100 m-0 d-flex">
            <Col
              sm={1}
              className="p-0 d-flex flex-column mr-3"
              ...
              <Container className=" pt-1 pb-1 p-0 w-100 d-flex flex-column align-items-center">
                ...
                <Container className="p-0 pb-2 w-100 border-bottom d-none">
                  <Row style={{}} className="d-block">
                    <Col className="">
                      <Button className="btn btn-light rounded-pill p-0">
                        <Container className="p-0 pl-1 pr-1">
                          <Container className="p-0" style={{ height: '30px' }}>
                            <svg
                              viewBox="0 0 24 24"
                              fill="#1da1f2"
